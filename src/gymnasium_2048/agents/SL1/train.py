...
from gymnasium_2048.agents.SL1.encoding import encode_boards_torch
from gymnasium_2048.agents.SL1.loss import masked_soft_cross_entropy
from gymnasium_2048.agents.SL1.model import (
    CNNConfig,
    SupervisedCNN,
    config_to_dict,
)
...
def train_supervised_cnn(config: SupervisedTrainingConfig) -> dict[str, Any]:
    ...
    print(f"SL1 action-probability CNN training device: {device}")
